...
function Header(props) {
  return <header>
    ...
    <meta name="google-signin-client_id" content="463041322252-4mb8hgo1qpdjtn6bdhqcqik644d1pna1.apps.googleusercontent.com.apps.googleusercontent.com"></meta>    
</header>
}
...
function Navigation(props) {
  ...
  return <nav>
    <ol>
      {lis}
      <li><div className="g-signin2" data-onsuccess="onSignIn"></div></li>
    </ol>
...
export default App;
// export default <GoogleOAuthProvider clientId="<your_client_id>"> {App} </GoogleOAuthProvider>;
